...
<body>
    ...
    <table class="striped responsive-table">
            ...
            <blockquote>
            <h2>Escriba el nombre del escritor</h2>
          </blockquote>

          <form class="col s12" action="resultadoBusquedaUsu.php" method="post">
            <div class="row">
              <div class="input-field col l10 s12 hide">
                ...
                <div class="input-field col l10 s12 hide">
                  <input name="estado" placeholder="Estado" id="estado" value="Publicado" type="text" class="validate">
