          ...
          <?php
                ...
                while($datos = mysqli_fetch_array($ejecuttar)) {
                  ...
                  <tr>
                          ...
                          <th><?php echo $datos['isbn_li']; ?></th>
                          <?php $ruta = "Libros/".$datos['isbn_li'].".pdf";?>
                          <th>
                            <a class="waves-effect waves-light btn-small" onclick="window.open('<?php echo($ruta)?>')">LEER LIBRO</a>      </th>
                            <th>
                            ...
                            <div class="input-field col l1 s12">
                              ...
                              <div class="input-field col l1 s12">
                                <input type="hidden" name="isbn" value="<?php echo $datos['isbn_li']?>"/>                   
                              </div>                      
                                <div class="col l5 s12">
                                  <button class="btn waves-effect waves-light" type="submit" name="boton">Aceptar
                            ...
                            <div class="input-field col l1 s12">
                              ...
                              <div class="input-field col l1 s12">
                                ...
                                <div class="col l5 s12">
                                  <button class="btn waves-effect waves-light" type="submit" name="boton">Cancelar
                                  <i class="material-icons right">send</i>
                                </div>
                            </div>
                          </form>                              
